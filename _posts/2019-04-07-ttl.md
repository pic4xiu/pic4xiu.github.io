...
我们没什么思路，只是看到很多TTL的值（**TTL是 Time To Live的缩写，该字段指定IP包被路由器丢弃之前允许通过的最大网段数量。TTL是IPv4包头的一个8 bit字段。**--摘自百度百科），TTL概念和做本题无关，在网上搜索了一波发现
...
今天做西湖论剑，本来本人研究逆向和pwn，结果全程划水，就解了几道题，还没逆向和pwn。逆向第一题是C++的时候心态都爆了，之后心情极度难受，主要还是太菜了，只有女神能缓解压力，焦灼等待writeup
