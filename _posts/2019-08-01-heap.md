...
```
free掉`aba`之后,我们看到在`fast bin`中有三个,其中0x602000~0x60201f为a,0x602020~0x60203f为b,而a的fd竟然指向b,两者在互指,2333
原因就是第二次`free(a)`的时候将arena的bin又指向了a,同时更新了一下a的fd,是之后的malloc按照arena的顺序进行
```
#include <stdio.h>
#include <stdlib.h>
