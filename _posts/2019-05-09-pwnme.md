...
之后就是找可利用的gadget了，根据[大佬](https://www.cnblogs.com/Ox9A82/p/5487725.html)的博客发现有两个通用的，，还有一个很难找的`pop rdi`，我们找到，但是有`pop r15`,利用该[网站](https://defuse.ca/online-x86-assembler.htm)看看机器码，该汇编的机器码是
